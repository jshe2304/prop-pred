...
from gat import GATTransformer
...
log_file = './logs/gat.csv'
weights_file = './weights/gat.pt'
...
model = GATTransformer(**hyperparameters).to(device)
...
for epoch in range(128):
    for smiles, d, y_true in train_dataloader:
        ...
        y_pred = model(
            numerical_node_features.float(), categorical_node_features, adj, padding
        )
